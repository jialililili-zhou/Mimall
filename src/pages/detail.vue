      ...
      <div class="container clearfix" >
        ...
        <div class="content">
          ...
          <div class="item-color">
            <h2>选择颜色</h2>
            <div class="phone" :class="{'checked':version1}" @click='click'>
          ...
          <div class="item-total">
            <div class="phone-info clearfix">
              <div class="fl">{{product.name}}  {{version==1 ? '6GB+64GB 全网通':''}}{{version==2 ? '4GB+64GB 移动4G':''}}  {{version1?'深空灰':''}}</div>
...
export default {
  ...
  methods:{
    ...
    addCart(){
      this.axios.post('/carts',{      //返回的数据中包含最新的购物车商品数量
        productId:this.id,
        selected: true
      }).then((res)=>{
